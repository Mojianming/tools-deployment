...
" 设置运行python代码
let g:pymode_run = 1
let g:python_run_bind = '<leader>r'
" 设置python断点
let g:pymode_breakpoint = 1
let g:python_breakpoint_bind = '<leader>b'
let g:python_breakpoint_cmd = ''
" 设置自动补全
" let g:pymode_rope_copletion = 1
" 跳转到函数定义处
